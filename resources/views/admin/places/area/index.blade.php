...
{{--                                </li>--}}
                                <li class="breadcrumb-item"><a href="{{ route('areas.index') }}">@lang('area')</a>
                                </li>
                            </ol>
                        </div>
                    </div>
                            ...
                            <div class="card-body">
                                <form id="search_form">
                                    <div class="row">
                                        ...
                                        <div class="col-3">
                                            <div class="form-group">
                                                <label for="s_city_uuid">@lang('countries')</label>
                                                <select name="s_city_uuid" id="s_city_uuid" class="search_input form-control">
                                                    <option selected disabled>@lang('select')  @lang('city')</option>
                                                    @foreach ($city as $itemm)
    ...
    <div class="modal fade" class="full-modal-stem" id="full-modal-stem" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('areas.store') }}" method="POST" id="add-mode-form" class="add-mode-form"
                    ...
                    <div class="modal-body">
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <select name="city_uuid" id="city_uuid" class="select form-control"
    ...
    <div class="modal fade" id="edit_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('areas.update') }}" method="POST" id="form_edit" class=""
                      enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <select class="form-control" id="edit_city_uuid" name="city_uuid" required>
                                    <option value="">@lang('select') @lang('city')</option>
                                    @foreach ($city as $itemm)
                                        <option value="{{ $itemm->uuid }}"> {{ $itemm->name }} </option>
                                    @endforeach
                                </select>
...
@section('scripts')
    ...
    <script type="text/javascript">
        ...
        var table = $('#datatable').DataTable({
            ...
            ajax: {
                url: '{{ route('areas.indexTable', app()->getLocale()) }}',
                data: function (d) {
